...
if (rowPos >= array2d.GetLength(0) || columnPos >= array2d.GetLength(1))
{
    Console.WriteLine("Вы вышли за пределы массива!");
}
else
{
    Console.WriteLine($"Значение элемента {rowPos} строки и {columnPos} столбца равно {array2d[rowPos, columnPos]}");
}
